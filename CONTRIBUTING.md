# Contributing to http-request-in-editor
...
* In GitHub, send a pull request to `.npmrc:master`.
...
we use the git commit messages to **generate the http-request-in-editor change log**.
...
Samples: (even more [samples](https://github.com/char0n/http-request-in-editor/commits/master))
