...
function id(x) { return x[0]; }
 const { request, requestWithBody, requestLine, messageLine } = require('./postprocessors');  var grammar = {
    ...
    {"name": "REQUEST", "symbols": ["REQUEST_LINE", "NEW_LINE", "HEADERS", "REQUEST$ebnf$3", "MESSAGE_BODY", "REQUEST$ebnf$4"], "postprocess": d => requestWithBody(d[0], d[2], d[4])},
    ...
    {"name": "MESSAGES", "symbols": ["MESSAGES$ebnf$1"], "postprocess": id},
    {"name": "MESSAGE_LINE$ebnf$1", "symbols": ["INPUT_CHARACTER"]},
    ...
    {"name": "MESSAGE_LINE", "symbols": ["INPUT_FILE_REF", "NEW_LINE"], "postprocess": d => d[0]},
    {"name": "INPUT_FILE_REF", "symbols": [{"literal":"<"}, "__", "FILE_PATH"], "postprocess": d => d[0] + " " + d[2]},
    {"name": "FILE_PATH$ebnf$1", "symbols": [/[^\r\n]/]},
    {"name": "FILE_PATH$ebnf$1", "symbols": ["FILE_PATH$ebnf$1", /[^\r\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
