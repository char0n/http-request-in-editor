...
function id(x) { return x[0]; }
 const { request, requestWithBody, requestLine, messageLine } = require('./postprocessors');  var grammar = {
    ...
    {"name": "REQUEST", "symbols": ["REQUEST$ebnf$1", "REQUEST_LINE", "REQUEST$ebnf$2"], "postprocess": d => request(d[1], [])},
    {"name": "REQUEST$ebnf$3", "symbols": []},
    {"name": "REQUEST$ebnf$3", "symbols": ["REQUEST$ebnf$3", "NEW_LINE"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "REQUEST$ebnf$4", "symbols": []},
    {"name": "REQUEST$ebnf$4", "symbols": ["REQUEST$ebnf$4", "NEW_LINE"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "REQUEST", "symbols": ["REQUEST$ebnf$3", "REQUEST_LINE", "NEW_LINE", "HEADERS", "REQUEST$ebnf$4"], "postprocess": d => request(d[1], d[3])},
    {"name": "REQUEST$ebnf$5", "symbols": []},
    {"name": "REQUEST$ebnf$5", "symbols": ["REQUEST$ebnf$5", "NEW_LINE"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "REQUEST$ebnf$6", "symbols": ["NEW_LINE"]},
    {"name": "REQUEST$ebnf$6", "symbols": ["REQUEST$ebnf$6", "NEW_LINE"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "REQUEST", "symbols": ["REQUEST$ebnf$5", "REQUEST_LINE", "NEW_LINE", "HEADERS", "REQUEST$ebnf$6", "MESSAGE_BODY"], "postprocess": d => requestWithBody(d[1], d[3], d[5])},
    ...
    {"name": "REQUEST_SEPARATOR$ebnf$1", "symbols": ["NEW_LINE"]},
    ...
    {"name": "REQUEST_SEPARATOR", "symbols": ["REQUEST_SEPARATOR$string$1", "REQUEST_SEPARATOR$ebnf$1"], "postprocess": () => ''},
