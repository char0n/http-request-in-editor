...
var grammar = {
    ...
    {"name": "REQUESTS_FILE$ebnf$1", "symbols": ["REQUESTS_FILE$ebnf$1", "REQUEST_SEPARATOR"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "REQUESTS_FILE$ebnf$2", "symbols": []},
    {"name": "REQUESTS_FILE$ebnf$2", "symbols": ["REQUESTS_FILE$ebnf$2", "REQUEST_WITH_SEPARATOR"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "REQUESTS_FILE$ebnf$3", "symbols": []},
    {"name": "REQUESTS_FILE$ebnf$3", "symbols": ["REQUESTS_FILE$ebnf$3", "REQUEST_SEPARATOR"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "REQUESTS_FILE", "symbols": ["REQUESTS_FILE$ebnf$1", "REQUEST", "REQUESTS_FILE$ebnf$2", "REQUESTS_FILE$ebnf$3"], "postprocess": d => [{lineTail: d[0][0], ...d[1]}, d[2][0]]},
    ...
    {"name": "REQUEST_WITH_SEPARATOR", "symbols": ["REQUEST_WITH_SEPARATOR$ebnf$1", "REQUEST"], "postprocess": d => ({ lineTail: '', ...d[1]})},
    ...
    {"name": "REQUEST", "symbols": ["REQUEST_LINE", "REQUEST$ebnf$1"], "postprocess": id},
    ...
    {"name": "REQUEST_TARGET$ebnf$1", "symbols": [/[^WHITESPACE]/]},
    {"name": "REQUEST_TARGET$ebnf$1", "symbols": ["REQUEST_TARGET$ebnf$1", /[^WHITESPACE]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "REQUIRED_WHITESPACE", "symbols": ["REQUIRED_WHITESPACE$ebnf$1"]},
    {"name": "_", "symbols": ["OPTIONAL_WHITESPACE"]},
    {"name": "__", "symbols": ["REQUIRED_WHITESPACE"]},
    ...
    {"name": "REQUEST_SEPARATOR", "symbols": ["REQUEST_SEPARATOR$string$1", "NEW_LINE"], "postprocess": () => ''},
    {"name": "REQUEST_SEPARATOR$string$2", "symbols": [{"literal":"#"}, {"literal":"#"}, {"literal":"#"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "REQUEST_SEPARATOR", "symbols": ["REQUEST_SEPARATOR$string$2", "LINE_TAIL"], "postprocess": d => d[1]}
]
