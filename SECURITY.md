...
This document outlines security procedures and general policies for the `http-request-in-editor`
project.
...
The `http-request-in-editor` team and community take all security bugs in `http-request-in-editor` seriously.
Thank you for improving the security of `http-request-in-editor`. We appreciate your efforts and
